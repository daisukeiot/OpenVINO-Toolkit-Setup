...
export PYTHONPATH=${INSTALL_DIR}/python3.7/lib/python2.7/dist-packages/:$PYTHONPATH
export PYTHONPATH=${INSTALL_DIR}/python3.7/lib/python3.7/dist-packages/:$PYTHONPATH
export LD_LIBRARY_PATH=${INSTALL_DIR}/python3.7/lib/:$LD_LIBRARY_PATH
