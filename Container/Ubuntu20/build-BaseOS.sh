if [ $# -ne 2 ]
  then
    ...
    echo "  OSVer          : Ubuntu OS Version"
    echo ""
    echo "  Example : ${0##*/} myregistry 20.04"
    echo "======================================="
    exit
fi
[ "$DEBUG" ] && set -x
...
TAG=${MY_REGISTRY}/openvino-container:ubuntu_${OS_VERSION}
...
# docker run -it --rm ${TAG} /bin/bash -c "python3 --version;ls /opt;lsb_release -a"
